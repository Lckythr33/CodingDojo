  ...
  <div class="card-body">
    ...
    <div class="notification">
		...
		<div>
			...
			<h4>Students: ${course.getUsers().size()} / ${course.capacity}</h4>
<%-- 			<a class="btn btn-secondary" href="/OldToNew/${course.id}">Ascending</a> <a class="btn btn-secondary" href="/NewToOld/${course.id}">Descending</a> --%>
		</div>
